  ...
  return (
    <>
      <div id="viewerApp" ref={viewerAppElement}>
        ...
        <div id="viewer">
          <canvas id="viewerCanvas" ref={canvasElement} onContextMenu={(e) => {e.preventDefault()}} className="border-2 border-emerald-300"></canvas>
          <canvas id="navCubeCanvas" ref={navCubeCanvasElement} onContextMenu={(e) => {e.preventDefault()}} className="border-2 border-violet-300"></canvas>
        </div>
      </div>
    </>
  );
